...
export const About = () => {
  return (
    <section id="about" className="py-24 px-4 bg-gradient-to-b from-muted/20 via-background to-muted/10 relative overflow-hidden">
          ...
          <div className="space-y-8 order-2 lg:order-1">
            <div className="space-y-6">
              <p className="text-lg leading-relaxed">
                I'm a dedicated Full Stack Developer with a <strong className="text-primary">Master's in Computer Science</strong> from the 
                University of South Florida and over <strong className="text-accent">4+ years of experience</strong> in building 
                enterprise-grade web applications.
              </p>
              
              <p className="text-lg leading-relaxed text-muted-foreground">
                My expertise spans the entire development stack - from creating secure, scalable APIs and 
                cloud-native backend systems using Java and Spring Boot, to building responsive, user-friendly 
                frontends with React.js and modern CSS frameworks. I'm passionate about creating complete 
                solutions that deliver exceptional user experiences.
              </p>
              
              <p className="text-lg leading-relaxed text-muted-foreground">
                I thrive in collaborative environments where I can contribute to innovative full stack solutions, 
                mentor team members, and continuously learn emerging technologies across the entire web 
                development ecosystem - from frontend frameworks to serverless architecture.
              </p>
            </div>
